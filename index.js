...
// ANSWER: They are both going to do the same thing just depends on the input
...
class numbersSum{
  ...
  addNumbers(num1, num2){
    let inputNums = `${num1}${num2}`
    if (this.cache.hasOwnProperty(inputNums)){
      return this.cache[inputNums]
    }
    let sum = num1 + num2
...
function addNumberNoCache (num1, num2){
  let sum = num1 + num2
  return sum
}
...
let addedNums = new numbersSum

console.time("not memoized function time");
console.log(addNumberNoCache(3,4))
console.log(addNumberNoCache(3,4))
console.log(addNumberNoCache(3,4))
console.log(addNumberNoCache(3,4))
...
console.log(addedNums.addNumbers(3,4))
console.log(addedNums.addNumbers(3,4))
console.log(addedNums.addNumbers(3,4))
console.log(addedNums.addNumbers(3,4))
